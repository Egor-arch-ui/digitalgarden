---
{"dg-publish":true,"permalink":"/plevrit/"}
---

# Плевриты. Этиология, патогенез, классификация, клиника, диагностика, принципы лечения (немедикаментозного, медикаментозного и с использованием физических факторов), профилактика.
